...
type: Portfolio
tags: ['Python', 'SQL', 'MS SQL', 'pandas', 'pyodbc', 'SQLAlchemy', 'Airflow']
stack: Python & MS SQL
date: '2022-04-20'
thumb: ../images/recent-spotify/Spotify_ETL.svg
featuredImg: ../images/recent-spotify/Spotify_ETL.svg
links: {
	GitHub: 'https://github.com/krozic/spotify_recent_song_etl',
}
description: [
...
\* ETL made with [draw.io](https://drive.google.com/file/d/1GGBgKkbAsrv0-ypzIxPXeZlYJxb4aL-O/view?usp=sharing)
...
<div style={{margin: '2rem 2.5rem'}}>
	<Image 
		src={ '/images/recent-spotify/table.png' }
		alt='table'
		layout='responsive'
		width={601}
		height={285}
...
<div style={{margin: '0rem 7rem'}}>
	<Image 
	src={ '/images/recent-spotify/permission.png' }
	alt='permission'
	layout='responsive'
	width={623}
	height={744}
...
<div style={{margin: '0rem'}}>
	<Image 
	src={ '/images/recent-spotify/url.png' }
	alt='url'
	layout='responsive'
	width={778}
	height={35}
