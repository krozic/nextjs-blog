...
links: {
	...
	App: 'https://imdb-genre-rank.onrender.com/'
}
description: [
...
*See my other [GitHub Repo](https://github.com/krozic/imdb-chrome-extension) for the chrome extension I built off this data.
...
<div>
	![app](/images/imdb-rating/app.png)
</div>
