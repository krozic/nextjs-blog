...
links: {
	...
	R Report: 'https://krozic.github.io/Word-Prediction-Model/'
}
description: [
...
This project was written as a report in Rmarkdown, and can be found [here](https://krozic.github.io/Word-Prediction-Model/)